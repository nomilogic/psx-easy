        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Advanced data visualization and AI-powered insights for Pakistan Stock Exchange
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <Card className="border-l-4 border-l-blue-500 hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600">Market Index</p>
                    <p className="text-2xl font-bold text-gray-900">KSE-100</p>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">{stocks?.length || 483}</p>
            ...
            <Card className="border-l-4 border-l-purple-500 hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600">Top Gainers</p>
                    <p className="text-2xl font-bold text-gray-900">{marketSummary?.gainers || 156}</p>
                    <p className="text-sm text-green-600 flex items-center mt-1">
                      <TrendingUp className="w-4 h-4 mr-1" />
                      Bullish
                    </p>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">
                      {marketSummary?.totalVolume ? 
                        (marketSummary.totalVolume / 1000000).toFixed(0) + "M" : 
                        "245M"
                      }
                    </p>
                    <p className="text-sm text-gray-500 mt-1">PKR Million</p>
                  </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>Real-time price movements and changes</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>Trading volumes by major sectors</CardDescription>
              </CardHeader>
              <CardContent>
                <ChartContainer config={{}} className="h-64">
                  <ResponsiveContainer>
                    <AreaChart data={sectorChartData}>
                      <XAxis dataKey="name" />
                      <YAxis />
                      <ChartTooltip content={<ChartTooltipContent />} />
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription className="text-lg mt-2">
                      Intelligent insights powered by advanced machine learning
                    </CardDescription>
                  </div>
                  <Button 
                ...
                {aiInsights?.insight ? (
                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-xl font-bold text-green-900">
                                {aiInsights.marketData?.avgChange > 0 ? 'Bullish' : 'Bearish'}
                              </p>
                            </div>
                        ...
                        <CardContent className="p-4">
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-xl font-bold text-blue-900">High</p>
                            </div>
                        ...
                        <CardContent className="p-4">
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-xl font-bold text-purple-900">Monitor</p>
                            </div>
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 mb-6 max-w-md mx-auto">
                      Click to generate comprehensive market insights using advanced AI algorithms and real-time PSX data.
                    </p>
                    <Button 
                      onClick={() => refetchInsights()}
                      size="lg"
