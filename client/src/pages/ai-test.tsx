...
const AI_MODELS = {
  ...
  pollinations: {
    popular: [
      ...
      { value: "openai-fast", label: "OpenAI GPT-4.1 Nano" },
      { value: "openai-large", label: "OpenAI GPT-4.1" },
      { value: "openai-reasoning", label: "OpenAI o4 Mini" },
      { value: "openai-audio", label: "OpenAI GPT-4o Mini Audio Preview" },
      { value: "gemini", label: "Gemini 2.5 Flash Lite" },
      { value: "gemini-search", label: "Gemini 2.5 Flash Lite with Google Search" },
      { value: "mistral", label: "Mistral Small 3.2 24B" },
      { value: "deepseek", label: "DeepSeek V3.1" },
    ],
    specialized: [
      { value: "bidara", label: "BIDARA (NASA Biomimetic Designer)" },
      { value: "chickytutor", label: "ChickyTutor AI Language Tutor" },
      { value: "evil", label: "Evil" },
      { value: "midijourney", label: "MIDIjourney" },
      { value: "qwen-coder", label: "Qwen 2.5 Coder 32B" },
      { value: "roblox-rp", label: "Llama 3.1 8B Instruct (Roblox RP)" },
      { value: "rtist", label: "Rtist" },
      { value: "unity", label: "Unity Unrestricted Agent" },
    ],
  },
};
