...
function Homepage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      {/* Navigation */}
      <nav className="bg-gradient-to-r from-green-700 to-blue-700 text-white shadow-lg sticky top-0 z-50">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              <div className="flex items-center space-x-3">
                ...
                <span className="font-bold text-xl">PAISX</span>
              </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
            <p>&copy; 2025 PAISX. All rights reserved. Powered by AI and Pakistan Stock Exchange data.</p>
          </div>
        </div>
      </footer>
    </div>
